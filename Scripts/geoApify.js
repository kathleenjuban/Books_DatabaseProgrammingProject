...
function addressAutocomplete(containerElement, callback, options) {
    ...
    inputElement.addEventListener("input", function (e) {
        ...
        var promise = new Promise((resolve, reject) => {
            ...
            var apiKey = "181e91b93e144a7e898809fe58765371";
...
addressAutocomplete(document.getElementById("autocomplete-container"), (data) => {
    ...
    console.log(data);
    //alert("Country:" + data.properties.country);
    //alert("State:" + data.properties.state);
    //alert("Address:" + data.properties.address_line1);
    //debugger;

    // AUTO-FILL
    $("#customerAddress").val(data.properties.address_line1);
    /*$("#customerCountry").val(data.properties.country);*/
